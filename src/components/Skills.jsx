import {
  ...
  CartesianGrid, Tooltip, PieChart, Pie, Cell, Legend, AreaChart, Area,
} from 'recharts'
...
const tooltipStyle = {
  contentStyle: {
    background: 'var(--el-tooltip-bg)',
    border: '1px solid var(--el-tooltip-border)',
    borderRadius: '12px',
    fontFamily: 'Inter',
    fontSize: '12px',
    color: 'var(--el-text)',
    boxShadow: 'var(--el-tooltip-shadow)',
  },
}
...
function StatCard({ label, value, suffix = '', isInView, reduced }) {
  ...
  return (
    <div className="card-base card-hover text-center p-6">
      <p className="font-heading text-4xl font-bold" style={{ color: 'var(--el-text)' }}>
...
export default function Skills() {
  ...
  const anim = (name, delay) =>
    reduced ? {} : { animation: sectionInView ? `${name} 0.7s cubic-bezier(.2,.8,.2,1) ${delay}s both` : 'none' }
  ...
  return (
    <section id="skills" className="section-padding" style={{ background: 'var(--el-bg)' }} aria-labelledby="skills-heading">
      <div className="container-main" ref={sectionRef}>
        <div className="text-center mb-16" style={anim('fadeUp', 0)}>
          <p className="font-body text-sm uppercase tracking-widest mb-3" style={{ color: 'var(--el-text-sub)' }}>Visual Stats</p>
          <h2 id="skills-heading" className="font-heading text-4xl md:text-5xl font-semibold" style={{ color: 'var(--el-text)' }}>
            Skills & Analytics
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div className="card-base card-hover" style={anim('fadeLeft', 0.1)}>
          ...
          <div className="card-base card-hover" style={anim('fadeRight', 0.2)}>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div className="card-base card-hover" style={anim('fadeLeft', 0.3)}>
          ...
          <div className="card-base card-hover" style={anim('fadeRight', 0.4)}>
                ...
                <BarChart data={weeklyProgress} barSize={32}>
                  ...
                  <Bar dataKey="hours" radius={[8, 8, 0, 0]}>
                    {weeklyProgress.map((entry, index) => (
                      <Cell key={`cell-${index}`} fill={index === 4 ? 'var(--el-highlight)' : 'var(--el-accent)'} />
                    ))}
                  </Bar>
                </BarChart>
              </ResponsiveContainer>
        ...
        <div className="card-base card-hover" style={anim('fadeUp', 0.5)}>
